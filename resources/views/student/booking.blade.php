                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ $booking->meeting->meeting_link }}" target="_blank" class="btn btn-primary">Join Now</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('student.cancel_booking', $booking->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm">Cancel</button>
                                    </form>
                                    @elseif ($booking->isInProgress)
                                    <span class="btn btn-warning btn-sm">Session in progress</span>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
