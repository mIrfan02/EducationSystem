            ...
            <form action="{{ route('sessions.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('session_type') is-invalid @enderror" id="session_type"
                            name="session_type" required>
                            <option value="">Select Session Type</option>
                            <option value="individual" {{ old('session_type') == 'individual' ? 'selected' : '' }}>
                                Individual</option>
                            <option value="group" {{ old('session_type') == 'group' ? 'selected' : '' }}>Group
                            </option>
                        </select>
                        @error('session_type')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
